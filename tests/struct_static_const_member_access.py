...
fn test() {
	unsafe {
		let v = my_test::MyTestConstructorSimpleStruct();
		assert_eq!(my_test::MyTestSimpleStructGetV(v), 3);

		assert_eq!(my_test::MyTestSimpleStructGetI(), 5);
		assert_eq!(my_test::MyTestSimpleStructGetS(), "some string");
	}
}
'''