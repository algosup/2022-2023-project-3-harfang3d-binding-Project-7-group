	...
	- ### Project Overview
		...
		- ### Goals, Product/Client requirements
			- #### Functional Requirements
				- #admon-question as mentioned in the *Functional Specifications*, the main objectives of our work are:
				  collapsed:: true
			...
			- #### Scope
				- ##### In Scope :
					- #admon-question Adding Rust language to fabgen
					- #admon-question Trying out FABGen on harfang.py
					- #admon-question Functional on Windows & Linux
					- #admon-question Documenting all the program to allow for easier developement in the future
					- #admon-question Passing all the tests provided by the customer
					- #admon-question Test Run on the Harfang 3D Engine
					- #admon-question Reverse Engineering FABGen
				- ##### Out of scope :
					- #admon-question modifying FABGen core logic
					- #admon-question Using 3rd party binders
					- #admon-question modifying other language implementations in FABGen
			- #### Quality Assurance Expectations
				- #admon-question The test coverage of FABGen was of 92%, A total of 29 tests provided by the customer, and and passing rate must be 100% to validate the implementation
			- #### License
				- #admon-question GNU GPL 3.0
				  collapsed:: true
					- |Permissions|Limitations|Conditions|
					  ...
					  |✅ Private use|||
		- ### Assumptions
			- #admon-info that FABGen is already "perfect" and that the existing code would not be responsible of further bugs
		...
		- ### Constraints
			- #admon-question not two way binding for the moment, unlike FABGen README states.
			- #admon-question No one has actual great knowledge of target language in group
	- ### Glossary
...
- ## Proposed Solution
	...
	- ### Risk assessment and security risks/measures
		- ![image.png](../images/technical/image_1673536919062_0.png){:height 271, :width 640}
		- Error Handling
		- Security
		- Privacy
